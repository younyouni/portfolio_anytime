		...
		$.ajax({
			...
			success : function(rdata){
				...
				if (rdata.notice.length > 0){
					let output = "";
					keyword = "'" + keyword + "'";
					$(rdata.notice).each(function(){
						output += '<a class="article" href="post/detail?post_id='+this.post_ID+'"><div class="desc">'
								+ '<h2 class="medium bold">'+this.subject+'</h2><p class="medium">'
								+ this.content + '</p><div class="info"><ul class="status"><li title="공감" class="vote">'
								+ this.like_COUNT + '</li></ul><time class="small">' + this.post_DATE 
...
<body>
	<div id="wrapper">
		...
		<div id="container" class="article notice" style="margin-top: 85px; margin-left: 35px;">
