$(function() {
   ...
   $("#write").click(function(){
      ...
      const buttonText = $("#write").text(); // 버튼의 라벨로 add 할 지 update 할 지 결정
   ...
   $("#comment").on("click", ".update", function() {
      let before = $(this).parent().prev().text()// 선택한 내용을 가져옵니다.
   ...
   $("#comment").on('click', '.cancel', function() {
      $("tr").removeAttr("style"); //<tr style="background-color: white;">
