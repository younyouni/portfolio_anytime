...
<link href="${pageContext.request.contextPath}/resources/css/common/common.css"
	rel="stylesheet">
<link href="${pageContext.request.contextPath}/resources/css/member/login/main.common.css"
	rel="stylesheet">
<link href="${pageContext.request.contextPath}/resources/css/member/login/main.login.css"
	rel="stylesheet">
...
<body style="">
	<div id="container" class="login">
		...
		<form action="${pageContext.request.contextPath}/member/loginProcess" method="post"
			...
			<p class="input">
				<input type="text" id ="login_id" name="login_id" maxlength="20" class="text"
